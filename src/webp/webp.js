...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_version')) {
        Object.defineProperty(Module['ready'], '_version', { configurable: true, get: function() { abort('You are getting _version on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_version', { configurable: true, set: function() { abort('You are setting _version on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_create_buffer')) {
        Object.defineProperty(Module['ready'], '_create_buffer', { configurable: true, get: function() { abort('You are getting _create_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_create_buffer', { configurable: true, set: function() { abort('You are setting _create_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_destroy_buffer')) {
        Object.defineProperty(Module['ready'], '_destroy_buffer', { configurable: true, get: function() { abort('You are getting _destroy_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_destroy_buffer', { configurable: true, set: function() { abort('You are setting _destroy_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_free_result')) {
        Object.defineProperty(Module['ready'], '_free_result', { configurable: true, get: function() { abort('You are getting _free_result on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_free_result', { configurable: true, set: function() { abort('You are setting _free_result on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_result_pointer')) {
        Object.defineProperty(Module['ready'], '_get_result_pointer', { configurable: true, get: function() { abort('You are getting _get_result_pointer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_result_pointer', { configurable: true, set: function() { abort('You are setting _get_result_pointer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_result_size')) {
        Object.defineProperty(Module['ready'], '_get_result_size', { configurable: true, get: function() { abort('You are getting _get_result_size on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_result_size', { configurable: true, set: function() { abort('You are setting _get_result_size on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
